...
#SBATCH -e /p/project/deepsea/geiss1/kripke-v1.2.7-ddcac43/build-gpu/results-zgd/logs/kpk-gpu.§NTASKS§_§REP§_%A_%a.err
#SBATCH -o /p/project/deepsea/geiss1/kripke-v1.2.7-ddcac43/build-gpu/results-zgd/logs/kpk-gpu.§NTASKS§_§REP§_%A_%a.out
#
#SBATCH -a 1-5 #1-5
#SBATCH -A deepsea
#SBATCH -p dp-esb
...
srun -c $OMP_NUM_THREADS ../sources/build-gpu/kripke.exe --groups 64 --gset 1 --quad 128 --dset 128 --legendre 4 --procs $x,$y,$z --zones $((m*x)),$((m*y)),$((m*z)) --niter 100 --layout ZGD