...
namespace miniFE
{
  ...
  namespace Hex8
  {
    ...
    __host__ __device__ KERNEL_PREFIX void shape_fns(const Scalar *x, Scalar *values_at_nodes)
    {
    ...
    template <typename Scalar>
    __host__ __device__ KERNEL_PREFIX void gradients(const Scalar *x, Scalar *values_per_fn)
    {
    ...
    template <typename Scalar>
    __host__ __device__ KERNEL_PREFIX void gradients_and_detJ(const Scalar *elemNodeCoords,
    ...
    __device__ __host__
        KERNEL_PREFIX void
        gradients_and_invJ_and_detJ(const Scalar *elemNodeCoords,
                                    const Scalar *grad_vals,
                                    Scalar *invJ,
                                    Scalar &detJ)
    {
    ...
    template <typename Scalar>
    __host__ __device__ KERNEL_PREFIX void diffusionMatrix_symm(const Scalar *elemNodeCoords,
                                                                const Scalar *grad_vals,
                                                                Scalar *elem_mat)
    {
...
//  }
    ...
    template <typename Scalar>
    __device__ __host__ KERNEL_PREFIX void sourceVector(const Scalar *elemNodeCoords,
                                                        const Scalar *grad_vals,
                                                        Scalar *elem_vec)
    {
