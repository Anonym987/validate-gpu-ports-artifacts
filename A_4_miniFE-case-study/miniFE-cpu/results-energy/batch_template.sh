...
#SBATCH -e /p/project/deepsea/geiss1/miniFE-2.2.0/openmp-opt/results-energy/logs/mFE-cpu.§NTASKS§_§REP§_%A_%a.err
#SBATCH -o /p/project/deepsea/geiss1/miniFE-2.2.0/openmp-opt/results-energy/logs/mFE-cpu.§NTASKS§_§REP§_%A_%a.out
#
#SBATCH -a 1-5 #1-5
#SBATCH -A deepsea
#SBATCH -p dp-cn
...
srun -c 48 ../sources/src-ep/miniFE.x -nx $((m*x)) -ny $((m*y)) -nz $((m*z))