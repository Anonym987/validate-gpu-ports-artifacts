...
#SBATCH -e /p/project/deepsea/geiss1/miniFE-2.2.0/openmp-opt-cuda/results/logs/mFE-gpu.§NTASKS§_§REP§_%A_%a.err
#SBATCH -o /p/project/deepsea/geiss1/miniFE-2.2.0/openmp-opt-cuda/results/logs/mFE-gpu.§NTASKS§_§REP§_%A_%a.out
#
#SBATCH -a 1-5 #1-5
#SBATCH -A deepsea
#SBATCH -p dp-esb
